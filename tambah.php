...
// Operasi TAMBAH DATA: Memproses form submit
if (isset($_POST['submit'])) {
    ...
    if ($status_kehadiran && $waktu && $tanggal && $nisn) {
        ...
        if ($query) {
            ...
            // Redirect ke halaman menampilkandata.php
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="card shadow">
            <h5 class="card-header text-center">Form Tambah Data Presensi</h5>
            <div class="card-body">
